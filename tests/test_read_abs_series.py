...
d, m = ra.read_abs_series(
    cat="5206.0", series_id=["A2304370T", "A2304372W"], ignore_errors=False, verbose=True
)
print(d, "\n", m)

# extract just one series (employed total persons (thousands))
d, m = ra.read_abs_series(cat="6202.0", series_id="A84423043C", ignore_errors=True, verbose=True)
print(d, "\n", m)
